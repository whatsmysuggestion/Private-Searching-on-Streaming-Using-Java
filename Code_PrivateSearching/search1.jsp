...
<div id="templatemo_wrapper">
    ...
    <ul class=" well nav nav-pills" style="height:20px;">
             ...
             <li style="margin-top:-5px;margin-bottom:-5px;">
                    <a href="edit.jsp" data-toggle="modal" style="font-size:16px;margin-left:8px;margin-right:10px;text-decoration:none;" >
                           Account Edit</a></li>
              <li style="margin-top:-5px;margin-bottom:-5px;">
                    <a href="view.jsp"  style="font-size:16px;margin-left:10px;margin-right:8px;text-decoration:none;" >
                          Account View</a></li>    
						  
						  
						  <li  class="active" style="margin-top:-5px;margin-bottom:-5px;">
                    <a href="search1.jsp"  style="font-size:16px;margin-left:10px;margin-right:8px;text-decoration:none;" >
                          Search</a></li>  
...
session.setAttribute("ttt",ttt);
    ...
    <form class="login1" name="fun" action="userfront11.jsp" method="get" onSubmit="return funn();">
      <h1><font color="#FCE7B7" face="Courier New, Courier, monospace" size="+2">Enter Your Keyword For <% out.print(searchtype);%>    Search</font></h1>
