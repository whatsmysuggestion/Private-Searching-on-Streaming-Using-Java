...
<div id="templatemo_wrapper">
	...
	<div id="templatemo_header">
           ...
           <div id="mid_title" style="margin-top:-15px;">
				<br/>
              <tehead style="text-align:justify;"> 
              Private Searching on Streaming Data Based on Keyword Frequency</tehead>
...
<!--
    ...
    <div id="templatemo_main" style="height:270px;">
		...
		<table align="center" height="300" width="500">
                        <tr align="center"> 
                          <td  align="center"><img src="images/bsearch.jpeg" width="400" height="200"  style=" margin-top:-100px;  border-radius:10px;box-shadow:5px 5px 5px 5px #ccc;" /> </td>
                        </tr>
