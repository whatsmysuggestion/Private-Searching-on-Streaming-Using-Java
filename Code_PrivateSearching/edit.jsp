...
try
 {
    ...
    <form class="login1" name="fun" action="regvalid.jsp" method="post" onsubmit="return funn();">
      <h1><font color="#FCE7B7" face="Courier New, Courier, monospace" size="+2">Your Account For Edit</font></h1>
            <input type="text" name="email" class="span4"  value="<%=email%>"  placeholder="Username"  />
      <br>
	  <br>
      
      <input type="text" name="dob" class="span4"  value="<%=dob%>"  placeholder="Re-Password"/>
      <br><br>
      
      <input type="email" name="address" class="span4"  value="<%=address%>"  placeholder="Email ID"/>
      <br><br>
	  
	  <input type="text" name="mobile" class="span4"  value="<%=mobile%>"  placeholder="Password"/>
      <br><br>
